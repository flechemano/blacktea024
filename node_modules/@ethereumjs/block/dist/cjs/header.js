...
class BlockHeader {
    ...
    static fromValuesArray(values, opts = {}) {
        ...
        if (header.common.isActivatedEIP(1559) && baseFeePerGas === undefined) {
            ...
            // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
            if (eip1559ActivationBlock && (0, util_1.equalsBytes)(eip1559ActivationBlock, number)) {
    ...
    ethashCanonicalDifficulty(parentBlockHeader) {
        ...
        else if (this.common.gteHardfork(common_1.Hardfork.Homestead) === true) {
    ...
    _validateDAOExtraData() {
        if (this.common.hardforkIsActiveOnBlock(common_1.Hardfork.Dao, this.number) === false) {
            return;
        }
