 ...
 */
exports.CODEHASH_PREFIX = Buffer.from('c');
/**
...
class DefaultStateManager extends baseStateManager_1.BaseStateManager {
    ...
    async putContractCode(address, value) {
        ...
        const key = this._prefixCodeHashes ? Buffer.concat([exports.CODEHASH_PREFIX, codeHash]) : codeHash;
        // @ts-expect-error
    ...
    async getContractCode(address) {
        ...
        const key = this._prefixCodeHashes
            ? Buffer.concat([exports.CODEHASH_PREFIX, account.codeHash])
            : account.codeHash;
        // @ts-expect-error
